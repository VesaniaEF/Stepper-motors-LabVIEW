...
void loop() {
  ...
  if (flame1 == 1) {  // si ocurre algun evento ==1 en alguno de los casos entra en el if y sellecciona la cantidad de mediciones, pasos y habilita el while
